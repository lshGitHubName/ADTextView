...
import com.junmeng.ysyx.gaojie.R;
...
public class ADTextView extends View {
    ...
    private void obtainStyledAttrs(AttributeSet attrs) {
        ...
        mFrontTextSize = (int) array.getDimension(R.styleable.ADTextView_ad_text_front_size, SizeUtil.Sp2Px(getContext(), 12));
        mContentTextSize = (int) array.getDimension(R.styleable.ADTextView_ad_text_content_size, SizeUtil.Sp2Px(getContext(), 12));
        array.recycle();
    }
